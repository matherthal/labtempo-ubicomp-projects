...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	public void show(int spriteX, int spriteY, int spriteW, int spriteH, View v, Activity act) {
		preShow();
		...
		Rect anchorRect = new Rect(x, y, x + spriteW, y + spriteH);
		...
		act.runOnUiThread(new Runnable() {
			...
			@Override
			public void run() {
				mWindow.showAtLocation(view, Gravity.NO_GRAVITY, xp, yp);
			}
		});
