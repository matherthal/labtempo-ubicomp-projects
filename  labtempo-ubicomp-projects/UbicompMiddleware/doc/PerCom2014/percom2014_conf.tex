...
%   um agente pode saber quais recursos mais próximo de um ponto de referência específico
  ...
  [media follow me]
  MediaFollowMe, which causes a multimedia stream (eg, video, audio, images) is transferred to the device (capable of displaying flow) closest to the user, as the media follow him
