...
Proposto inicialmente em \cite{cardoso2006} como uma entidade de coleta de informações de contexto, a estrutura do AR permite resolver o desafio da heterogeneidade de dispositivos, como abordado em \cite{mareli2013}. A estrutura geral do AR possui, dentre outros atributos, uma hierarquia de tipos, que é composta por uma sequência de classes, tendo sido inspirada na ontologia descrita em~\cite{ranganathan2005olympus} para classificar entidades. A hierarquia possibilita a consulta e instanciação de ARs a partir de propriedades associadas a uma classe específica. 
...
Alguns trabalhos utilizam um motor de regras para avaliar as regras de contexto~\cite{wang2005towards,chen2010context,biegel2004framework}. Em \cite{liu2003dios++} as regras são avaliadas em agentes distribuídos, mas controladas por um motor de regras centralizado. Embora o \textit{framework} proposto não imponha a utilização de um motor de regras, e o \textit{SmartAndroid} não faça uso de um, este poderia ser facilmente agregado e se aproveitar da infraestrutura de acesso aos recursos.
