...
//	 public static final String RDS_ADDRESS = "rai:" + ResourceAgentIdentifier.getLocalIpAddress() +
//	 "//br.uff.tempo.middleware.management.ResourceDiscovery:ResourceDiscovery";
	//public static final String RDS_ADDRESS = "rai:192.168.1.71//br.uff.tempo.middleware.management.ResourceDiscovery:ResourceDiscovery";
