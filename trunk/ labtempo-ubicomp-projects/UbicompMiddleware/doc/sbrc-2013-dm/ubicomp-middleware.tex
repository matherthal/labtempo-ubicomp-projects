...
Considere a seguinte regra: se uma pessoa (que mora sozinha) ligou o fogão, se deitou na cama, e se passaram 15min, então dispare o alarme do dispertador e mostre na televisão a mensagem ``O fogão foi esquecido ligado!''. Este exemplo simplista poderia ser implementando no sistema como na figura.................................%TODO: terminard escrever isso
A Figura~\ref{fig:inpt_cute} apresenta um exemplo de uso da interpretação de contexto. Na figura, o IC criado recebe notificações do AR da cama e do fogão

%falar sobre a arquitetura do IC e da sua criação
O IC é também um AR e possui na sua arquitetura uma estrutura de dados que guarda a referência para as CVs de interesse
guarda em uma estrutura de dados 

que possuem uma expressão lógica que relaciona 
