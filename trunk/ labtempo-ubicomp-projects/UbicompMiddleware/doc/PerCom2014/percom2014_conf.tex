...
%   to combine CVs from different RAs and set the connectives, forming 
%   choose the CV by clicking on the resource representation at the PIPA
...
%   ; ; defin
%   First of all the user must select Compose a Context Rule in the configuration menu presented below on the Figure~\ref{fig:ipgap}. 
