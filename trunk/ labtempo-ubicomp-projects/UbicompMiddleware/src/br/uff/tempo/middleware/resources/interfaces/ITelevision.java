...
public interface ITelevision {
	 ...
	 * @param text The message that will be showed in the screen
	 */
	 ...
	 * @param channel An integer that represents the new channel
	 */
	 ...
	 * @param on <code>true</code> to turn the TV on; <code>false</code> to turn the TV off
	 */
	 ...
	 * @param inc The unit that the TV volume will be increased
	 */
	public void incVolume(int inc);
	
	/**
	 * Decreases the TV volume in <code>dec</code> units
	 * @param dec The unit that the TV volume will be decreased
	 */
