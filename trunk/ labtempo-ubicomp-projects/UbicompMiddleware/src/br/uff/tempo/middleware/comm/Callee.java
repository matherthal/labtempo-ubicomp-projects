...
public class Callee {
		...
		public void run() {
			try {
				if (SERVERIP != null) {
					...
					// Repetition to create one threads to each call from
					// clients
					while (true) {
	 ...
	 * ex) { Log.e("ServerActivity", ex.toString()); } return null; }
	 */

	/*
	 * //Method for Debug private void printOnScreen(final String msg) {
